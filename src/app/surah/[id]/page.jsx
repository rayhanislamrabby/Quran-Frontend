              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <span
                      className={`w-8 h-8 flex items-center justify-center rounded-xl font-bold text-xs ${
                        isActive
                  ...
                  <div className="text-right mb-6">
                    <p
                      className={`font-arabic leading-[2.6] transition-all ${
                        isActive
                          ? "text-green-900 text-3xl"
                  ...
                  <div className="text-left border-l-2 border-gray-100 pl-6">
                    <p
                      className={`text-[8px] font-black uppercase tracking-widest mb-2 ${isActive ? "text-green-600" : "text-gray-400"}`}
                    >
                      Saheeh International
                    </p>
                    <p
                      className={`text-lg leading-relaxed ${isActive ? "text-gray-900 font-medium" : "text-gray-600"}`}
                    >
                      {ayah.text_english}
                    </p>
                  </div>
